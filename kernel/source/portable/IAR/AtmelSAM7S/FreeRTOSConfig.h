...
{  \
  extern void vApplicationTaskCreateFailedHook( void );   \
  vApplicationTaskCreateFailedHook( );   \
}
#define traceCREATE_MUTEX_FAILED( ) \
{   \
  extern void vApplicationMutexCreateFailedHook( void );   \
  vApplicationMutexCreateFailedHook( );   \
}  
#define traceQUEUE_CREATE_FAILED( ) \
{   \
   extern void vApplicationQueueCreateFailedHook( void );   \
   vApplicationQueueCreateFailedHook( );  \
}     
