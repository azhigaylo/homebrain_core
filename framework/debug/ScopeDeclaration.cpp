...
{  
  ...
  DBG_SCOPE_DEF ( CxLogDevice,            CxLogDevice            )
  DBG_SCOPE_DEF ( CxEventDispatcher,      CxEventDispatcher      )
  DBG_SCOPE_DEF ( CxLauncher,             CxLauncher             )    
  DBG_SCOPE_DEF ( CxDataProvider,         CxDataProvider         )         
  //DBG_SCOPE_DEF ( CxConnectionManager,    CxConnectionManager    )     
